...
- **官方翻译**：用可配置按键显示当前剧情台词、普通 NPC 对话、队友旅途对话或已完成“打听/调查”的人物资料所对应的游戏官方文本；默认按 `T`。默认为简体中文。
- **语言解析**：用可配置按键显示当前台词的词汇、读音、词性和语法；默认按 `V`。默认为日文。剧情台词、普通 NPC 对话和队友旅途对话包含离线解析数据，人物资料页已接入解析界面并在暂无数据时显示提示。
- **提示**：剧情演出的台词显示四项快捷键提示；普通 NPC 对话、队友旅途对话和“打听/调查”资料页显示翻译与解析快捷键提示。
